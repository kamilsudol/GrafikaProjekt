...
public:
		...
		MyFrame1( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = _("Grafika Projekt"), const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 600,400 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
